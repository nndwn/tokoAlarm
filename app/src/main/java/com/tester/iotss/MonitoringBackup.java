...
public class MonitoringBackup extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blinkAnimation.setDuration(500); // Durasi animasi dalam milidetik (misalnya 500ms)
        ...
        FirebaseApp.initializeApp(MonitoringBackup.this);
        sessionLogin = new SessionLogin();
        FirebaseMessaging.getInstance().subscribeToTopic(sessionLogin.getNohp(getApplicationContext()));
        loadingDialog = new LoadingDialog(MonitoringBackup.this);
        alertSuccess = new AlertSuccess(MonitoringBackup.this);
        alertError = new AlertError(MonitoringBackup.this);
        ...
        swMode.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(checkeddaridata==false) {
                    if (tvIdAlat.getText().toString().length() > 1) {
                        if (b) {
                            if (sendToServer(tvIdAlat.getText().toString() + "/mode", "otomatis")) {
                            ...
                            if (sendToServer(tvIdAlat.getText().toString() + "/mode", "manual")) {
                                swMode.setText("Manual");
                                btnAlarm.setVisibility(View.VISIBLE);
                            } else {
        ...
        swIn1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(checkeddaridata==false) {
                    if (tvIdAlat.getText().toString().length() > 1) {
                        if (b) {
                            if (sendToServer(tvIdAlat.getText().toString() + "/statin1", "1")) {
                            ...
                            if (sendToServer(tvIdAlat.getText().toString() + "/statin1", "0")) {
                                swIn1.setText("Disable");
                            } else {
        ...
        swIn2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(checkeddaridata==false) {
                    if (tvIdAlat.getText().toString().length() > 1) {
                        if (b) {
                            if (sendToServer(tvIdAlat.getText().toString() + "/statin2", "1")) {
                            ...
                            if (sendToServer(tvIdAlat.getText().toString() + "/statin2", "0")) {
                                swIn2.setText("Disable");
                            } else {
        ...
        swIn3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(checkeddaridata==false) {
                    if (tvIdAlat.getText().toString().length() > 1) {
                        if (b) {
                            if (sendToServer(tvIdAlat.getText().toString() + "/statin3", "1")) {
                            ...
                            if (sendToServer(tvIdAlat.getText().toString() + "/statin3", "0")) {
                                swIn3.setText("Disable");
                            } else {
        ...
        AndroidNetworking.post(BASE_URL+"users/bookalatdetail")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    if(status){
                                        ...
                                        Toast.makeText(MonitoringBackup.this.getApplicationContext(),person.getString("message"),Toast.LENGTH_LONG).show();
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Log.d("FRAGMENTHOMELOG",e.getMessage());
                                    Toast.makeText(MonitoringBackup.this,"Terjadi Kesalahan "+e.getMessage(),Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    ...
                    public void onError(ANError error) {
                        ...
                        Toast.makeText(MonitoringBackup.this,"Terjadi Kesalahan "+error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    }
    ...
    private void konekMQTT(){
        diskonekMQTT();
        mqttHelper = new MqttHelper(MonitoringBackup.this,BrokerUri);
    ...
    private void showBottomSheetDialog(String before_rename,String label) {
        ...
        sheetDialog = new BottomSheetDialog(MonitoringBackup.this);
