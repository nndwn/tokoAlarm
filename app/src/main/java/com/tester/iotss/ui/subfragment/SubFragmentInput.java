...
//        String kode_tps="",provinsi="",kabupaten="",kecamatan="",kelurahan="";
//        try{
//            JSONObject data = new JSONObject(sessionLogin.getPenugasan(getContext()));
//            kode_tps = data.getString("kode_tps");
...
//
//        }
//        AndroidNetworking.post(BASE_URL+"webservice/paslon/historyinput")
