 ...
 */
public class SubFragmentKirim extends Fragment implements SwipeRefreshLayout.OnRefreshListener {


    public SubFragmentKirim() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_sub_fragment_kirim, container, false);
