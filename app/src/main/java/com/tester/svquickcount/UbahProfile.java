...
public class UbahProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edNama.setText(sessionLogin.getNama_pelanggan(getApplicationContext()));
        edEmail.setText(sessionLogin.getEmail_pelanggan(getApplicationContext()));
        edHp.setText(sessionLogin.getNohp_pelanggan(getApplicationContext()));
                        ...
                        public void onResponse(JSONObject person) {
                            ...
                            try {
                                ...
                                if (isSuccess) {
                                    ...
                                    sessionLogin.setNohp_pelanggan(edHp.getText().toString(),getApplicationContext());
                                    sessionLogin.setEmail_pelanggan(edEmail.getText().toString(),getApplicationContext());
                                    sessionLogin.setNama_pelanggan(edNama.getText().toString(),getApplicationContext());
